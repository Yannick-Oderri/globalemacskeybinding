...
FilteredWindowList := Object()
FilteredWindowMatchMode := Object()
...
f_AddFilterWindow( "ahk_class ConsoleWindowClass" )
f_AddFilterWindow( "ahk_class illustrator" )
f_AddFilterWindow( "ahk_class photoshop" )
f_AddFilterWindow( "Blender" )
f_AddFilterWindow( " — Atom$", "RegEx" )
f_AddFilterWindow( "sublime_text", "RegEx" )
f_AddFilterWindow( "sublime_text" )
f_AddFilterWindow( "ahk_class PX_WINDOW_CLASS" )
f_AddFilterWindow("ahk_exe WindowsTerminal.exe")
f_AddFilterWindow("ahk_class CASCADIA_HOSTING_WINDOW_CLASS")
;==========================
;Functions
;==========================
...
f_AddFilterWindow( windowTitle, matchMode=1 )
{
  ;global ; Sets entire function global
	...
	global FilteredWindowMatchMode

	global FilteredWindowCount
	FilteredWindowList.Insert(windowTitle)
	FilteredWindowMatchMode.Insert(matchMode)
	FilteredWindowCount += 1
}
...
f_IsFilteredWindow( )
{
	...
	Loop, % FilteredWindowCount
	{
    		;MsgBox, % FilteredWindowList[A_Index - 1]
		;SetTitleMatchMode % FilteredWindowMatchMode[A_Index -1]
...
WinGet, Window_Proc, ProcessName, %ActiveTitle%
if Window_Proc = chrome.exe
 sendinput ^+{tab}
return
